...
require 'bitbucket_api/constants'
require 'bitbucket_api/utils/url'
require 'bitbucket_api/connection'
require 'bitbucket_api/deprecation'
require 'bitbucket_api/core_ext/ordered_hash'
